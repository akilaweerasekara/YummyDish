...
<footer style="background:#0d0d0d;border-top:1px solid rgba(255,255,255,.06);padding:64px 0 0;margin-top:80px;position:relative;overflow:hidden;">
  <div style="position:absolute;top:-120px;left:-100px;width:500px;height:500px;background:radial-gradient(circle,rgba(255,107,53,.07) 0%,transparent 65%);pointer-events:none;"></div>
  <div class="container-xl" style="position:relative;z-index:1;">
    <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1.2fr;gap:48px;margin-bottom:48px;" class="ft-grid">
      <div>
        ...
        <div style="display:flex;gap:10px;">
          <a href="#" aria-label="Facebook"  class="ft-soc"><i class="bi bi-facebook"></i></a>
          <a href="#" aria-label="Instagram" class="ft-soc"><i class="bi bi-instagram"></i></a>
          <a href="#" aria-label="WhatsApp"  class="ft-soc"><i class="bi bi-whatsapp"></i></a>
          <a href="#" aria-label="YouTube"   class="ft-soc"><i class="bi bi-youtube"></i></a>
        </div>
      </div>
      <div>
        <div class="ft-hd">Quick Links</div>
        <ul class="ft-ul">
          <li><a href="/menu"     class="ft-lnk">&#x1F37D;&#xFE0F; Full Menu</a></li>
          <li><a href="/schedule" class="ft-lnk">&#x1F4C5; Schedule Order</a></li>
          <li><a href="/group"    class="ft-lnk">&#x1F465; Group Orders</a></li>
          <li><a href="/activity" class="ft-lnk">&#x1F4E6; My Orders</a></li>
          <li><a href="/reviews"  class="ft-lnk">&#x2B50; Reviews</a></li>
          <li><a href="/account"  class="ft-lnk">&#x1F464; My Account</a></li>
        </ul>
      </div>
      <div>
        <div class="ft-hd">Information</div>
        <ul class="ft-ul">
          <li><a href="/about"   class="ft-lnk">About Us</a></li>
          <li><a href="/contact" class="ft-lnk">Contact Us</a></li>
          <li><a href="#"        class="ft-lnk">Privacy Policy</a></li>
          <li><a href="#"        class="ft-lnk">Terms of Service</a></li>
          <li><a href="#"        class="ft-lnk">Refund Policy</a></li>
          <li><a href="#"        class="ft-lnk">Allergen Info</a></li>
        </ul>
      </div>
      <div>
        <div class="ft-hd">Contact Us</div>
        <div style="display:flex;flex-direction:column;gap:12px;">
          ...
          <div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:13px 15px;margin-top:4px;">
            ...
            <div style="font-size:.79rem;display:flex;justify-content:space-between;margin-bottom:4px;"><span style="color:rgba(255,255,255,.45);">Saturday</span><strong style="color:white;">9AM &ndash; 11PM</strong></div>
            <div style="font-size:.79rem;display:flex;justify-content:space-between;"><span style="color:rgba(255,255,255,.45);">Sunday</span><strong style="color:white;">10AM &ndash; 9PM</strong></div>
          </div>
        </div>
      </div>
    </div>
    <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:center;padding:24px 0;border-top:1px solid rgba(255,255,255,.06);border-bottom:1px solid rgba(255,255,255,.06);margin-bottom:24px;">
      <span class="ft-trust"><i class="bi bi-shield-check-fill" style="color:#22C55E;"></i> Safe &amp; Hygienic</span>
      <span class="ft-trust"><i class="bi bi-lightning-fill" style="color:#FFB800;"></i> 28 Min Delivery</span>
      <span class="ft-trust"><i class="bi bi-geo-alt-fill" style="color:var(--c-orange);"></i> Live GPS Tracking</span>
      <span class="ft-trust"><i class="bi bi-star-fill" style="color:#FFB800;"></i> 4.8 &#9733; Rated</span>
      <span class="ft-trust"><i class="bi bi-arrow-repeat" style="color:#667eea;"></i> Loyalty Rewards</span>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;padding-bottom:28px;">
      ...
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        ...
        <span class="ft-pay" style="background:rgba(37,211,102,.1);border-color:rgba(37,211,102,.3);color:#25D366;">WPay</span>
      </div>
    </div>
  </div>
</footer>
