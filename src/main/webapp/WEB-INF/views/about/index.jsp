...
.count-up{font-size:2.8rem;font-weight:800;color:var(--copper);}
...
.team-avatar{width:80px;height:80px;border-radius:50%;object-fit:cover;margin:0 auto 14px;border:3px solid var(--copper);}
...
.val-card:hover{border-color:var(--copper);transform:translateY(-4px);box-shadow:var(--shadow-lg);}
...
<div class="yd-page">
  ...
  <div class="about-hero">
    ...
    <div class="container" style="position:relative;z-index:1;">
      <div style="max-width:600px;">
        <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,107,53,.15);border:1px solid rgba(255,107,53,.3);color:var(--copper);padding:6px 16px;border-radius:20px;font-size:.8rem;font-weight:700;margin-bottom:20px;">
          <span class="yd-live-dot"></span>EST. 2024 · KANDY, SRI LANKA
        </div>
        <h1 style="font-family:var(--font-serif);font-size:clamp(2.4rem,5vw,4rem);color:white;line-height:1.1;margin-bottom:16px;">
        ...
        <p style="color:rgba(255,255,255,.65);font-size:1.05rem;line-height:1.75;max-width:480px;margin-bottom:28px;">
          Katagasma was born from a simple belief: great food should be accessible to everyone, delivered hot, fresh, and fast.
        </p>
  ...
  <!-- Stats bar -->
  <div style="background:linear-gradient(135deg,var(--copper),var(--copper-d));padding:32px 0;">
    <div class="container">
  ...
  <div class="container py-5" style="max-width:960px;">
    ...
    <div class="text-center mb-5 yd-fade">
      <h2 style="font-family:var(--font-serif);font-size:2.2rem;margin-bottom:8px;">Why Choose Us?</h2>
    ...
    <!-- Map -->
    <div class="yd-fade">
      <h3 style="font-family:var(--font-serif);text-align:center;margin-bottom:20px;">📍 Find Us in Kandy</h3>
      <div id="aboutMap" style="width:100%;height:350px;border-radius:20px;border:1px solid var(--c-border);overflow:hidden;"></div>
      <p class="text-center mt-3" style="color:var(--c-muted);font-size:.875rem;">Katagasma Kitchen, Kandy Town, Sri Lanka · Open 7am – 11pm daily · +94 81 234 5678</p>
    </div>
    ...
    <div class="yd-card mt-5 yd-fade" style="background:linear-gradient(135deg,#0F0F0F,#1a1a1a);border:none;text-align:center;padding:48px 32px;">
      ...
      <h3 style="font-family:var(--font-serif);color:white;margin-bottom:10px;">Ready to Order?</h3>
...
onMapsReady(function() {
  ...
  YDMaps.addMarker(map, r.lat, r.lng, r.name,
    '<div style="font-family:sans-serif;padding:10px 14px;"><strong style="font-size:14px;">🍽️ Katagasma Kitchen</strong><br><span style="font-size:12px;color:#888;">Open 7am–11pm · +94 81 234 5678</span><br><a href="/menu" style="color:#FF6B35;font-size:12px;font-weight:600;">Order Now →</a></div>');
});

// Count-up animation on scroll
function animateNumber(el,start,end,duration){var range=end-start,startTime=null;function step(ts){if(!startTime)startTime=ts;var progress=Math.min((ts-startTime)/duration,1);el.textContent=Math.floor(progress*range+start).toLocaleString()+(el.dataset.suffix||"");if(progress<1)requestAnimationFrame(step);}requestAnimationFrame(step);}
